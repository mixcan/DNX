...
// Copyright (c) 2009-2020 The Dnxcoin Core developers
 ...
 * database.
 *
 * CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1610618733, nBits=1d00ffff, nNonce=250578689, vtx=1)
...
{
    const char* pszTimestamp = "After 2021 Human and bean go to school info heart vector design for life";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1610618733, 250578689, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000c179090b1b3bc7ab150262133709b47cef5cbf2a21dbbe09b2b00524"));
        assert(genesis.hashMerkleRoot == uint256S("0x952a353993ac123abee2b17c70be050736eb958eaa6ed9313f45551a0c0c7aeb"));
        ...
        // release ASAP to avoid it where possible.
         vSeeds.emplace_back("162.0.214.40"); // Pieter Wuille, only supports x1, x5, x9, and xd
        ...
        vSeeds.emplace_back("162.0.214.40");
