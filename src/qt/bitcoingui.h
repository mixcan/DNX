...
/**
  Dnxcoin GUI main class. This class represents the main window of the Dnxcoin UI. It communicates with both the client and
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Dnxcoin Transaction from file or clipboard */
